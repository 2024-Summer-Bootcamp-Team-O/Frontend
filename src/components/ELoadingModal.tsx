...
const LLoadingModal: React.FC<LoadingModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className='flex w-screen h-screen items-center justify-center bg-black bg-opacity-70 z-50'>
            <div className='flex flex-col w-[57.8rem] h-[43.6rem]' style={{backgroundImage:`url(${ELoadingImg})`, backgroundSize:'cover'}}>
                ...
                <div className='flex w-[51.2rem] h-[3rem] ml-[4.61rem] mt-[0.19rem] overflow-hidden'>
                    <div className='flex h-full' style={{width:`${progress}%`, transition:'width 3.2s linear', overflow:'hidden'}}>
