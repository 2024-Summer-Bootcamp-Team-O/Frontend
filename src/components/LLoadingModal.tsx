    ...
    return (
        <div className='fixed top-0 left-0 flex flex-col items-center justify-center w-screen h-screen bg-black bg-opacity-70 '>
            <div className='flex flex-col 4k:mt-[4rem] 4k:w-[57rem] 4k:h-[43rem]
                ...
                1k:mt-[2.5rem] 1k:w-[42.5rem] 1k:h-[32rem] ' style={{backgroundImage:`url(${'https://d2skuaswcwq39b.cloudfront.net/baseimage/LLoadingImg.png'})`, backgroundSize:'cover'}}>
                <div className='flex 4k:w-[50rem] 4k:h-[10rem] 4k:mt-[7.2rem]
                3k:w-[40.7rem] 3k:h-[6.2rem] 3k:mt-[5.7rem]
                2k:w-[42rem] 2k:h-[6.2rem] 2k:mt-[6.17rem]  
                1k:w-[38.5rem] 1k:h-[6.2rem] 1k:mt-[5.1rem] overflow-hidden'>
                    <div className='flex h-full' style={{width:'100%', transition:'transform 4s linear', transform: animate ? 'translateX(calc(100% - 6.2rem))' : 'translateX(0)'}}>
                        <img src='https://d2skuaswcwq39b.cloudfront.net/baseimage/Human.png' alt='Moving Human' className='4k:w-[5.4rem] 4k:h-[5.4rem] 4k:mt-[2.47rem] 3k:w-[4.7rem] 3k:h-[4.7rem] 3k:mt-[1.5rem] 2k:w-[5rem] 2k:h-[5rem] 2k:mt-[1.2rem] 1k:w-[4.5rem] 1k:h-[4.5rem] 1k:mt-[1.6rem]'/>
                    </div>
                </div>
                ...
                1k:w-[37.6rem] 1k:h-[2.186rem] 1k:ml-[3.48rem] 1k:mt-[0.01rem] overflow-hidden'>
                    <div className='flex h-full' style={{width:`${progress}%`, transition:'width 3.0s linear', overflow:'hidden'}}>
                        {Array(Math.ceil(51.2/1.43631)).fill(0).map((_,index) => (
                            <img key={index} src='https://d2skuaswcwq39b.cloudfront.net/baseimage/LoadingPer.png' alt='Loading Per' className='h-full w-[1.43631rem] 4k:w-[3rem]'/>
                        ))}
                    </div>
                </div>
            </div>
