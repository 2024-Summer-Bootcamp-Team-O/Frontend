...
const FeedBackModal: React.FC<FeedBackModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className={`top-0 left-0 flex w-screen h-screen bg-black bg-opacity-80 ${isOpen ? 'modal-overlay' : ''}`}>
            ...
            <div className='flex flex-grow flex-col w-[65.31rem] h-full '>
                ...
                <div className="flex flex-col w-full h-[39.17rem] justify-end items-end">
                    <button className="flex text-white text-[2.625rem] font-dgm mb-[2.75rem] mr-[7.38rem]">
