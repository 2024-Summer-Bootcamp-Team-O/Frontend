...
const CameraModal: React.FC<CameraModalProps> = ({ isOpen, onClose }) => {
    ...
    <div className="fixed top-0 left-0 flex flex-col items-center justify-between w-full h-full bg-black bg-opacity-80">
            ...
            z-10 bg-contain bg-no-repeat" style={{ backgroundImage: `url(${memberCard_s})` }}>
                <div className="flex flex-col items-center 4k:mt-[9.2rem] 3k:mt-[6rem] 2k:mt-[8rem] 1k:mt-[9.5rem] justify-self-center">
                    ...
                    <div className="flex space-x-4 ">
                        {isCaptureEnable ? (
                            <>
                                <button onClick={recapture} className="flex items-center justify-start bg-[#ECFFD9] hover:bg-[#DEFDFF] rounded-lg text-black border-black border-solid font-dgm 
                                4k:w-[7.8rem] 4k:h-[2.4rem] 4k:mt-4 4k:mb-[4rem] 4k:text-[1rem] 4k:border-[2.5px]
                                3k:w-[6.5rem] 3k:h-[2rem] 3k:mt-2 3k:mb-7 3k:text-[0.9rem] 3k:border-[2.0px]
                                2k:w-[7rem] 2k:h-[2rem] 2k:mt-3 2k:mb-14 2k:text-[0.95rem] 2k:border-[2.0px]
                                1k:w-[6rem] 1k:h-[1.7rem] 1k:mt-[0.52rem] 1k:mb-[6.5rem] 1k:text-[0.85rem] 1k:border-[2.0px]">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 11 11" fill="none" className='4k:ml-3 4k:mr-2 4k:w-[1rem] 3k:ml-3 3k:mr-1 3k:w-[0.8rem] 2k:ml-3 2k:mr-2 2k:w-[0.95rem] 1k:ml-2 1k:mr-1 1k:w-[0.75rem]'>
                                ...
                                <button onClick={handleConfirm} className="flex items-center justify-start bg-[#ECFFD9] hover:bg-[#DEFDFF] rounded-lg text-black border-black border-solid font-dgm 
                                4k:w-[7.8rem] 4k:h-[2.4rem] 4k:mt-4 4k:mb-[4rem] 4k:text-[1rem] 4k:border-[2.5px]
                                3k:w-[6.5rem] 3k:h-[2rem] 3k:mt-2 3k:mb-7 3k:text-[0.9rem] 3k:border-[2.0px]
                                2k:w-[7rem] 2k:h-[2rem] 2k:mt-3 2k:mb-14 2k:text-[0.95rem] 2k:border-[2.0px]
                                1k:w-[6rem] 1k:h-[1.7rem] 1k:mt-[0.52rem] 1k:mb-[6.5rem] 1k:text-[0.85rem] 1k:border-[2.0px]">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 12 12" fill="none" className='4k:ml-3 4k:mr-5 4k:w-[1.3rem] 3k:ml-3 3k:mr-3 3k:w-[1.1rem] 2k:ml-3 2k:mr-5 2k:w-[1.1rem] 1k:ml-2 1k:mr-4 1k:w-[1rem]'>
                            ...
                            <button onClick={capture} className=" 4k:mt-1 4k:mb-10 3k:-mt-2 3k:mb-2 2k:-mt-3 2k:mb-10 1k:-mt-4 1k:mb-[5rem] group outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 68 68" fill="none" className='4k:w-[7rem] 3k:w-[4.5rem] 2k:w-16 1k:w-[3.5rem]'>
        ...
        <p className="4k:text-[2.8rem] 4k:mb-48 3k:text-[2rem] 3k:mb-24 2k:text-[2rem] 2k:mb-32 1k:text-[1.9rem] 1k:mb-28 text-white font-dgm ">
