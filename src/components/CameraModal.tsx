        ...
        <div className="flex flex-col items-center justify-center flex-grow w-[25.625rem] h-[55rem] bg-contain bg-no-repeat bg-[url('src/assets/images/others/memberCard_strap_s.png')]">
            <div className="flex flex-col items-center justify-center mt-[12rem]">
                ...
                <div className="flex space-x-4 ">
                    {isCaptureEnable ? (
                        <>
                            <button onClick={recapture} className="flex items-center justify-start w-[7.5rem] h-[2.0rem] mt-4 mb-6 bg-[#ECFFD9] hover:bg-[#DEFDFF] rounded-lg text-black border-[2.0px] border-black border-solid font-dgm text-[0.95rem]">
