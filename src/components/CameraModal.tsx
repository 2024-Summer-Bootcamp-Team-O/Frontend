...
const CameraModal: React.FC<CameraModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
    <div className="fixed top-0 left-0 flex flex-col items-center justify-center w-screen h-screen bg-black bg-opacity-80">
        <div className="flex flex-col items-center justify-center flex-grow w-[25.625rem] h-[55rem] bg-contain bg-no-repeat bg-[url('src/assets/images/others/memberCard_strap_s.png')]">
            <div className="flex flex-col items-center justify-center mt-44">
                ...
                <div className="flex space-x-4 ">
                    {isCaptureEnable ? (
                        <>
                            <button onClick={recapture} className="flex items-center justify-start w-[5.625rem] h-[1.6875rem] mt-4 mb-6 bg-[#ECFFD9] hover:bg-[#DEFDFF] text-black border border-black border-solid font-dgm text-[0.75rem]">
                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 11 11" fill="none" className='ml-2 mr-2 w-[0.65rem]'>
