    ...
    <div className="flex justify-center w-screen h-screen" style={{ backgroundImage: `url(${backgroundImg})`, backgroundSize: 'cover' }}>
      <div className="flex 1k:w-[94.5rem] 1k:h-[51.5rem] 2k:w-[108rem] 2k:h-[59.9375rem] 3k:w-[120rem] 3k:h-[57.5625rem] 4k:w-[160rem] 4k:h-[79.4375rem]">
        <div className="flex flex-col w-[37.5rem] h-[69.81rem] justify-end 1k:w-[36rem] 1k:h-[51.5rem] 2k:w-[40.63rem] 2k:h-[59.937rem] 3k:w-[48rem] 3k:h-[57.5625rem] 4k:w-[67.31rem] 4k:h-[79.4375rem]">
          ...
          <div className="bg-no-repeat 1k:w-[23.56rem] 1k:h-[11rem] 1k:ml-[9rem] 1k:mr-[5.46rem] 1k:pt-[0.9rem] 1k:pl-[0.1rem] 2k:w-[27rem] 2k:h-[12rem] 2k:mb-[0.7rem] 2k:mt-[0.5rem] 2k:mr-[1.0rem] 2k:pt-[1.1rem] 2k:pr-[0.15rem] 3k:w-[25rem] 3k:h-[11.5rem] 3k:-mb-[1.2rem] 3k:ml-[13rem] 3k:pt-[0.8rem] 4k:w-[32rem] 4k:h-[14.72rem] 4k:ml-[24.5rem] 4k:pt-[1.1rem] 4k:mb-[0.01rem]" style={{ backgroundImage: `url(${duckBubble})`, backgroundSize: 'cover' }}>
        ...
        <div className="flex flex-col  w-[70.5rem] 1k:w-[58.5rem] 2k:w-[70.5rem] 3k:w-[72rem] 4k:w-[92.69rem]">
          <div className="w-[67.3rem] h-[51.43rem] mr-[3.33rem] mt-[9.06rem] 1k:w-[50.5rem] 1k:h-[38.5rem] 1k:mr-[6rem] 1k:mt-[7.0rem] 2k:w-[59.875rem] 2k:h-[45.7rem] 3k:w-[57.15rem] 3k:h-[43.6rem] 4k:w-[74.7rem] 4k:h-[57rem] 4k:mt-[12rem]" style={{ backgroundImage: `url(${myPageImg})`, backgroundSize: 'cover' }}>
