...
import strapImage from '../assets/images/others/strap.png';
import memberCardImage from '../assets/images/others/memberCard_r.png';
import shareButtonUi from '../assets/images/others/sharebutton_ui.png';
import shareButtonUiHover from '../assets/images/others/sharebutton_ui_p.png';
import miniPageImage from '../assets/images/background/minipage_r.png';
...
const UserResultPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col w-screen h-screen bg-cover" style={{ backgroundImage: `url(${backgroundImage})` }}>
            ...
            {resultData && (
                <div className="flex items-center flex-1 justify-evenly">
                    <div className="flex flex-col items-center self-start -translate-y-44 ml-28 justify-center rotate-[12.21deg]">
                        <img src={strapImage} alt="Strap" className="w-[15rem] h-[30rem] z-10" />
                        <div className="flex flex-col items-center -mt-10 translate-x-8 justify-center w-[23rem] h-[33rem] bg-contain bg-no-repeat" style={{ backgroundImage: `url(${memberCardImage})` }}>
                    ...
                    <div className="flex flex-col items-end">
                        <div id="Page" className="flex flex-col items-center justify-center mr-5 w-[50rem] h-[50rem] bg-contain bg-no-repeat" style={{ backgroundImage: `url(${miniPageImage})` }}>
