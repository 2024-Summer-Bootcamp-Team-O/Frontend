    ...
    return(
			<div className="flex items-center justify-center w-screen h-screen bg-cover bg-main_h">
				<div className='flex'>
					...
					<span className="absolute ml-6 text-[2.8rem] text-black top-36 left-30 font-dgm">다음 알바다!</span>
					<img src="src/assets/images/icon/human_icon.png" alt="human" className='absolute w-32 h-32 top-[19rem]'/>
					<img src="src/assets/images/icon/store_icon.png" alt="destination" className='absolute w-28 h-28 left-[77rem] top-[20.1rem]'/>
