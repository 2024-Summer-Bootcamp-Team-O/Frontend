    ...
    return (
        <div className="relative h-screen w-screen flex" style={{backgroundImage: `url(${backgroundImg})`,backgroundSize:'cover'}}>
            <div className="flex flex-col w-[37.5rem] h-[69.81rem] justify-end ">
                ...
                < img src={duckImg} alt="duck" className="w-[34rem] h-[45rem] ml-[1.94rem] mr-[1.94rem] mb-[2.69rem]"/>
            </div>

            < div className="flex flex-col right-0 w-[70.5rem] h-[69.81rem]">
                <div className="relative w-[66.62rem] h-[51.43rem] mr-[3.33rem] mt-[9.06rem] mb-[9.88rem] " style={{ backgroundImage: `url(${characterPageImg})`, backgroundSize: 'cover' }}>
                    {/*상단바 div*/}
                    <div className="w-full h-[5.3125rem]"></div> 
                    {/*카드 스크롤 div*/}
                    <div className="overflow-y-auto webpage-scrollbar w-[66.625rem] h-[45.2rem]">
                        <div className="pt-[2.5rem] pr-[3.5rem] pl-[3.5rem] grid grid-cols-3 gap-7">
