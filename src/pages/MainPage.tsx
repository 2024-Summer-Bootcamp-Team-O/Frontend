...
const MainPage: React.FC = () => {
    ...
    return (
        <div className="flex justify-center w-screen h-screen" style={{backgroundImage: `url(${backgroundImg})`,backgroundSize:'cover'}}>
            <div className="flex w-[108rem] place-content-between 1k:w-[94.5rem] 1k:h-[51.5rem] 2k:w-[108rem] 2k:h-[59.9375rem] 3k:w-[120rem] 3k:h-[57.5625rem] 4k:w-[] 4k:h-[]">
                <div className="flex flex-col justify-end 1k:w-[36rem] 1k:h-[51.5rem] 2k:w-[40.63rem] 2k:h-[59.937rem] 3k:w-[48rem] 3k:h-[57.5625rem] 4k:w-[] 4k:h-[]">
                    <div className="1k:pl-[3.06rem] 1k:pb-[2.3rem] 2k:pb-[2.5rem] 2k:pl-[3.5rem] 3k:pb-[1.5rem] 3k:pl-[3.7rem] 4k:pb-[] 4k:pl">
                        <button
                            type="button" 
                            className='flex items-center justify-center text-[2rem] font-dgm text-black hover:text-[#3735A3] 1k:text-[1.5rem] 2k:text-[2.2rem] 3k:text-[2.3rem] 4k:text-[]'
                            onClick={handleLogOut}>
                            로그아웃
                            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="41" viewBox="0 0 31 41" fill="none" className="ml-3 1k:w-[1.5rem] 1k:h-[2.0rem] 1k:mt-[0.3rem] 2k:w-[2.7rem] 2k:h-[2.7rem] 3k:w-[2.8rem] 3k:h-[2.8rem] 3k:mt-[0.2rem]">
                    ...
                    <div className="bg-cover bg-no-repeat 1k:w-[23.56rem] 1k:h-[11rem] 1k:ml-[9rem] 1k:mr-[5.46rem] 1k:pt-[0.9rem] 1k:pl-[0.1rem] 2k:w-[27rem] 2k:h-[12rem] 2k:mb-[0.7rem] 2k:mt-[0.5rem] 2k:mr-[1.0rem] 2k:pt-[1.1rem] 2k:pr-[0.15rem] 3k:w-[25rem] 3k:h-[11.5rem] 3k:-mb-[1.2rem] 3k:ml-[13rem] 3k:pt-[0.8rem] 4k:w-[] 4k:h-[]" style={{ backgroundImage: `url(${duckBubble})` }}>
                        <p className="text-black text-center font-dgm text-[1.625rem] not-italic font-normal leading-normal tracking-[-0.04875rem] whitespace-pre-line 1k:text-[1.35rem] 2k:text-[1.55rem] 3k:text-[1.5rem] 4k:text-[]">
                            나는 MZ요정일세 ! <br />
                            자네는 깨어있는 MZ라고 생각하나? <br />
                            내가 한번 시험해보겠네.
                        </p>
                    </div>
                    <img src={duckImg} alt="duck" className=" 1k:w-[25rem] 1k:h-[32rem] 1k:mb-[1.44rem] 1k:ml-[7rem] 1k:mr-[4.16rem] 2k:w-[29.5rem] 2k:h-[36.5rem] 2k:mb-[1.9rem] 3k:w-[29.5rem] 3k:h-[37rem] 3k:ml-[11.3rem] 4k:w-[] 4k:h-[]"/>
                </div>

                <div className="flex flex-col w-[70.5rem] 1k:w-[58.5rem] 2k:w-[70.5rem] 3k:w-[72rem]">
                    <div className='flex justify-end'>
                        <button
                            type="button" 
                            className='flex items-center justify-center text-[2.5rem] font-dgm mt-[1.5rem] mb-[1.7rem] mr-[3.0rem] text-black hover:text-[#3735A3] 1k:mr-[3.0rem] 1k:mt-[2.2rem] 1k:text-[1.5rem] 2k:text-[2.2rem] 2k:mr-[3.5rem] 2k:mt-[2.5rem] 3k:text-[2.3rem] 3k:mr-[3.8rem] 3k:mt-[2.85rem]'
                            onClick={handleButtonClick}>
                            마이페이지 
                            <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none" className='1k:w-[2.3rem] 1k:h-[2.3rem] 1k:ml-[0.5rem] 1k:mt-[0.4rem] 2k:w-[3.0rem] 2k:h-[3.0rem] 2k:ml-[0.7rem] 2k:mt-[0.4rem] 3k:w-[3.4rem] 3k:h-[3.4rem]'>
                    ...
                    <div className="w-[67.3rem] h-[51.43rem] mr-[3.33rem] 1k:w-[50.5rem] 1k:h-[38.5rem] 1k:mr-[6rem] 2k:w-[59.875rem] 2k:h-[45.7rem] 3k:w-[57.15rem] 3k:h-[43.6rem]" style={{ backgroundImage: `url(${characterPageImg})`, backgroundSize: 'cover' }}>
                        <div className="w-full 1k:h-[4.02rem] 2k:h-[4.77rem] 3k:h-[4.59rem]"></div> 
                        <div className="w-[67rem] h-[45.9rem] 1k:w-[50.21rem] 1k:h-[34.5rem] 2k:w-[59.6rem] 2k:h-[41.2rem] 3k:w-[56.8rem] 3k:h-[39.03rem]">
                            <div className="webpage-scrollbar overflow-y-auto h-[34.2rem] pt-[2.5rem] pr-[3.5rem] pl-[3.5rem] grid grid-cols-3 gap-7 1k:h-[34.28rem] 1k:pt-[1.5rem] 1k:pr-[2.0rem] 1k:pl-[2.0rem] 2k:h-[40.6rem] 2k:pt-[2.0rem] 2k:pl-[2.5rem] 2k:pr-[2.7rem] 3k:h-[38.73rem] 3k:pt-[2.3rem] 3k:pl-[2.3rem] 3k:pr-[2.5rem]">
                    ...
                    <div className="flex justify-end">
                        <button
                            type="button" 
                            className='flex items-center justify-center text-[2.5rem] font-dgm mt-[1.5rem] mb-[1.7rem] mr-[3.0rem] text-black hover:text-[#3735A3] 1k:text-[1.9375rem] 1k:mr-[9rem] 2k:text-[1.9375rem] 2k:mr-[10rem] 3k:text-[1.9375rem] 3k:mr-[12rem]'
                            onClick={handleButtonClick}>
                            시뮬레이션 하러 가기 ! 
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="31" viewBox="0 0 26 31" fill="none" className='ml-10 1k:ml-[2rem]'>
