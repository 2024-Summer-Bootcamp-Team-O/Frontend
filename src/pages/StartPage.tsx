  ...
  return (
    <div className="flex flex-col items-center justify-end w-screen h-screen bg-cover" style={{ backgroundImage: `url(${background_s})` }}>
      ...
      <div className="flex flex-row items-end justify-center w-full">
        <img src={bg_stand1} alt="male_a" className="z-10   4k:w-[40rem] 4k:ml-[8rem]       3k:w-[30rem] 3k:ml-28         2k:w-[30rem]    2k:ml-12          1k:w-[27rem]                     lg:w-[22rem] lg:ml-10           md:w-[15rem] md:ml-8" />
        <img src={bg_stand2} alt="female_a" className="z-20 4k:w-[40rem] 4k:-ml-[17rem]     3k:w-[30rem] 3k:-ml-[11rem]   2k:w-[30rem]    2k:-ml-[12rem]    1k:w-[27rem]   1k:-ml-[9rem]     lg:w-[22rem] lg:-ml-[8rem]      md:w-[15rem] md:-ml-[6rem]" />
        <img src={bg_stand3} alt="female_b" className="z-30 4k:w-[40rem] 4k:-ml-[11rem]     3k:w-[30rem] 3k:-ml-[7.4rem]  2k:w-[30rem]    2k:-ml-[9rem]     1k:w-[27rem]   1k:-ml-[7.3rem]   lg:w-[22rem] lg:-ml-[6.8rem]    md:w-[15rem] md:-ml-[4.6rem]" />
        <img src={bg_stand4} alt="male_b" className="z-25   4k:w-[42rem] 4k:-ml-[15.7rem]   3k:w-[32rem] 3k:-ml-[11rem]   2k:w-[32rem]    2k:-ml-[12rem]    1k:w-[28.5rem] 1k:-ml-[10rem]    lg:w-[23rem] lg:-ml-[10rem]     md:w-[16rem] md:-ml-[6rem]" />
      </div>
    </div>
  );
}
