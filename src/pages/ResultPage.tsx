...
const ResultPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col w-screen h-screen bg-contain  " style={{ backgroundImage: `url(${backgroundCity})` }}>
                ...
                <div className="flex items-center flex-1 justify-evenly">
                    <div className="flex items-center 1k:w-[42rem] 2k:w-[48.87rem] 3k:w-[54.19rem] 4k:w-[75.565rem] 4k:h-full">
                        <div className="flex flex-col items-center self-start -translate-y-44 ml-28 justify-center rotate-[12.21deg] 1k:ml-[15rem] 2k:ml-[17rem] 3k:ml-[23rem] 4k:ml-[35rem]">
                            <img src={strap} alt="Strap" className="w-[15rem] h-[30rem] z-10 1k:w-[11rem] 1k:h-[29rem] 2k:w-[13rem] 2k:h-[33.5rem] 3k:w-[14rem] 3k:h-[32rem] 4k:w-[18rem] 4k:h-[37rem]" />
                            <div className="flex flex-col items-center -mt-8 translate-x-6 justify-center w-[23rem] h-[33rem] bg-contain bg-no-repeat 1k:w-[18.26rem] 1k:h-[26.37rem] 2k:w-[20rem] 2k:h-[30em] 3k:w-[21rem] 3k:h-[32rem] 3k:translate-x-7  4k:w-[29rem] 4k:h-[42rem] 4k:bg-cover 4k:translate-x-9 4k:-mt-10" style={{ backgroundImage: `url(${memberCard})` }}>
                    ...
                    <div className="flex flex-col 1k:w-[56.5rem] 1k:h-full 2k:w-[59.13rem] 3k:w-[65.81rem] 4k:w-[84.435rem] ">
                        ...
                        <div id="Page" className="flex flex-col items-center justify-center  w-[50rem] h-[50rem] bg-cover bg-no-repeat 1k:w-[39.7rem] 1k:h-[39.79rem] 1k:ml-[2rem] 1k:mt-[1rem] 2k:w-[45rem] 2k:h-[45rem] 2k:mt-[1.5rem] 3k:h-[44rem] 3k:w-[44rem] 3k:-mt-[0.1rem] 4k:bg-cover 4k:w-[59rem] 4k:h-[59rem] 4k:mt-[2rem]" style={{ backgroundImage: `url(${minipage})` }}>
                            ...
                            <div className="space-x-10">
                                <button
                                    type="button"
                                    className="bg-contain bg-no-repeat font-dgm text-[1.25rem] text-center w-[9.375rem] h-[3.4375rem] hide-on-capture 1k:text-[1.0rem] 1k:mt-[1rem] 1k:w-[7rem] 1k:h-[2.5rem] 2k:w-[8rem] 2k:text-[1.1rem] 2k:h-[3.0rem] 2k:mt-[1.5rem] 3k:w-[] 3k:h-[] 4k:text-[1.3rem] 4k:w-[10rem] 4k:h-[3.5rem]"
                                ...
                                <button
                                    type="button"
                                    className="bg-contain bg-no-repeat font-dgm text-[1.25rem] text-center w-[9.375rem] h-[3.4375rem] hide-on-capture 1k:text-[1.0rem] 1k:w-[7rem] 1k:h-[2.5rem] 2k:w-[8rem] 2k:text-[1.1rem] 2k:h-[3.0rem] 2k:mt-[1.5rem] 3k:w-[] 3k:h-[] 4k:text-[1.3rem] 4k:w-[10rem] 4k:h-[3.5rem]"
                                    style={{ backgroundImage: `url(${sharebutton_ui})` }}
                                    onMouseOver={(e) => (e.currentTarget.style.backgroundImage = `url(${sharebutton_ui_p})`)}
                                    onMouseOut={(e) => (e.currentTarget.style.backgroundImage = `url(${sharebutton_ui})`)}
