    ...
    return (
        <div className="flex items-center justify-evenly w-screen h-screen bg-cover bg-[url('src/assets/images/background/city.png')]">
            <div className="flex flex-col self-start items-center justify-center w-[46rem] h-[68rem] bg-contain bg-no-repeat bg-[url('src/assets/images/others/memberCard_strap.png')]">
                <img src="src/assets/images/standing/cha.png" alt="UserImage" className="rotate-[12.21deg] w-[17.125rem] h-[22.375rem] mt-40 mr-24" />
                <p className="rotate-[12.21deg] text-[2.25rem] font-dnf mt-2 mr-48"> 차 은 우 </p>
            </div> 
            <div className="flex flex-col items-center justify-center mr-5 w-[50rem] h-[50rem] bg-contain bg-no-repeat bg-[url('src/assets/images/background/minipage_r.png')]">
                <div className="flex justify-center w-[43rem] h-[35rem] mt-20 mr-5 bg-[#DCDCDC] border-solid border-2 border-black">
