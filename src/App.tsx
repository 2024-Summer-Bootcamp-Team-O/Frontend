...
import './index.css'; // TailwindCSS 스타일 파일 임포트
import './App.css';   // 추가적인 CSS 파일 임포트
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-screen h-screen bg-cover bg-main_s">
      <div className="relative w-full h-full">
        ...
        <h1 className="absolute z-40 font-bold text-center transform -translate-x-1/2 top-36 left-1/2 text-9xl gradient-text font-dnf rotate-355 text-border">
          걔, 킹받네 ?
        </h1>
